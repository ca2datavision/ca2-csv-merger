    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 max-w-2xl mx-auto mb-6">
            <p className="text-blue-800 font-medium">
              🔒 {t('privacy.title')}: {t('privacy.description')}
            </p>
        ...
        {files.length > 0 && (
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold">{t('selectedFiles.title')}</h2>
              <p className="text-sm text-gray-500">
                {t('selectedFiles.dragInfo')}
              </p>
            </div>
            <FileList
              files={files}
        ...
        { (
          <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
            <div className="flex flex-col items-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('share.title')}</h3>
        ...
        <footer className="mt-12 text-center">
          ...
          <p className="text-gray-600 mb-2">{t('footer.builtBy')}</p>
          <a
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-sm text-gray-500 bg-gray-50 rounded-lg p-4">
              <h4 className="font-medium mb-2">{t('footer.disclaimer.title')}</h4>
              <p>
      ...
      {isPreviewOpen && mergedData && (
        <PreviewDialog
          ...
          fileName={selectedPreviewFile?.name || t('preview.title')}
          onClose={() => {
